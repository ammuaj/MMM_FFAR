...
= 8 February 2019 =
* Update logic for selecting template parts, to make sure the portfolio taxonomy archives display the project grid correctly.

= 7 February 2019 =
* Correct button appearance.

= 6 February 2019 =
* Prevent media from being split between columns in the two-column panels on the homepage.

= 5 February 2019 =
* Do not centre menu in the Customizer.
