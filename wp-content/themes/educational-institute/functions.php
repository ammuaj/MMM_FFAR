...
add_action( 'init', 'educational_institute_remove_my_action');
function educational_institute_remove_my_action() {
    remove_action( 'admin_menu','elearning_education_menu' );
    remove_action( 'admin_notices','elearning_education_activation_notice' );
}
