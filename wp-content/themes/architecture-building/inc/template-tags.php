...
if ( ! function_exists( 'architecture_building_entry_footer' ) ) :
/**
 * Prints HTML with meta information for the categories, tags and comments.
 */
function architecture_building_entry_footer() {
	$separate_meta = __( ', ', 'architecture-building' );
	$categories_list = get_the_category_list( $separate_meta );
	$tags_list = get_the_tag_list( '', $separate_meta );
	if ( ( ( architecture_building_categorized_blog() && $categories_list ) || $tags_list ) || get_edit_post_link() ) {
...
function architecture_building_edit_link() {
	edit_post_link(
		sprintf(
			...
			__( 'Edit<span class="screen-reader-text"> "%s"</span>', 'architecture-building' ),
			get_the_title()
		),
...
function architecture_building_categorized_blog() {
	$category_count = get_transient( 'architecture_building_categories' );
	...
	if ( false === $category_count ) {
		...
		set_transient( 'architecture_building_categories', $category_count );
	}
