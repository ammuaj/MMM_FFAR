	...
	class PageTemplatesDirectory {
		...
		public function gutenberg_templates_list() {
			...
			'sktplants-gutenberg'              => array(
					...
					'keywords'    => __( ' Gutenberg, gutenberg, garden shop, gardener, gardener shop, gardening, gardening website, landscape gardener, nursery shop, plant flowers, plant nursery, plant shop, plants, plants store, plants theme, plant, garden, farm, flower, garden plants, houseplants' ),
			),				
		...
		public function templates_list() {
			...
			$templates_list = array(
				...
				'sktkarate-elementor'              => array(
					...
					'keywords'    => __( ' sports, coaches, trainers, sportsmen, runner companies, healthy lifestyle, health, fitness store, karate, Kung-Fu, boxing, krav maga, striking styles, standup styles, shoot fighting, Russian sambo, wrestling, grappling styles', 'skt-templates' ),
				),					
				'sktspecialisthome-elementor'              => array(
					...
					'keywords'    => __( ' specialist, corporate, business, consulting, agency, people, meeting, communal, working, workforce, office, accounting, lawyer, coaching, advocate, advice, suggestion, information security, computer based, computer security, biosecurity, information technology, insurance', 'skt-templates' ),
				),
				...
				'sktecology-elementor'              => array(
					...
					'keywords'    => __( ' ecology, eco products, natural, cultivation Website, organic farming, ecosystem service, welfare organizations, forest ecosystem, non profit organizations, NGO, carbon storage, ecological services, renewable energy, eco friendly, solar, recycle, reusable, conservation, agriculture, agro', 'skt-templates' ),
				),			
				...
				'sktwomanhome-elementor'              => array(
					...
					'keywords'    => __( ' woman, therapists, coaches, speakers, mentors, entrepreneurs, feminine, feminist, feminism, women empowerment, therapists, young woman, entrepreneurs, lifestyle, parenting challenges, relationships, therapy, appointment, individual therapy, training, healing trust, family counseling', 'skt-templates' ),
				),					
				...
				'taxihome-elementor'              => array(
					...
					'keywords'    => __( ' taxi, airport pickup, car rental, party bus, vehicle companies, transportation industry, travel agencies, motor rental, ola, uber, taxi, vehicle lease, two wheeler hire', 'skt-templates' ),
				),	 					
				...
				'comingsoonone-elementor'              => array(
					...
					'keywords'    => __( ' coming soon, coming soon page, under construction, holding page, maintenance mode, upcoming, arriving, getting ready, countdown, timer', 'skt-templates' ),
				),	
		...
		public function import_elementor( \WP_REST_Request $request ) {
			...
			if($template_name=='Wedding Cards Home' || $template_name=='Wedding Cards About' || $template_name=='Wedding Cards' || $template_name=='Wedding Cards Contact' || $template_name=='Extreme Sports Home' || $template_name=='Extreme Sports About' || $template_name=='Extreme Sports Activities' || $template_name=='Extreme Sports Contact' || $template_name=='Mechanic Home' || $template_name=='Mechanic About' || $template_name=='Mechanic Services' || $template_name=='Mechanic Contact' || $template_name=='Taxi Home' || $template_name=='Taxi About' || $template_name=='Taxi Services' || $template_name=='Taxi Reviews' || $template_name=='Taxi Contact' || $template_name=='Woman Home' || $template_name=='Woman About' || $template_name=='Woman Services' || $template_name=='Woman Contacts' || $template_name=='Specialist Home' || $template_name=='Specialist About' || $template_name=='Specialist Services' || $template_name=='Specialist Contact'){
